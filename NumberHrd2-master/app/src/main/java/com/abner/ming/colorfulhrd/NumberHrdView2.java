...
public class NumberHrdView2 extends View {
    ...
    public NumberHrdView2(Context context) {
        super(context);
    }
    public NumberHrdView2(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initView(context);
    }

    public NumberHrdView2(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        createView_9();
        createView_10();
        createView_11(0, floatX, 0, floatY);
        createView_12(floatX * 3, floatX * 4, 0, floatY);
    ...
    public void createView_1() {
        ...
        my_Square[1].y_0 = floatY;
        my_Square[1].y_1 = floatY*3;
    ...
    public void createView_3() {
        ...
        my_Square[3].y_0 = floatY;
        my_Square[3].y_1 = floatY*3;
    }

    public void createView_4() {
        my_Square[4].x_0 = floatX;
        my_Square[4].x_1 = floatX*2;
        my_Square[4].y_0 = floatY*2;
        my_Square[4].y_1 = floatY*4;
    }

    public void createView_5() {
        my_Square[5].x_0 = floatX*2;
        my_Square[5].x_1 = floatX*3;
        my_Square[5].y_0 = floatY*2;
        my_Square[5].y_1 = floatY*4;
    }

    public void createView_6() {
        my_Square[6].x_0 = 0;
        my_Square[6].x_1 = floatX;
        my_Square[6].y_0 = floatY*3;
    ...
    public void createView_8() {
        my_Square[8].x_0 = 0;
        my_Square[8].x_1 = floatX*2;
        my_Square[8].y_0 = floatY*4;
        my_Square[8].y_1 = mHeight;
    }

    public void createView_9() {
        my_Square[9].x_0 = floatX*2;
        my_Square[9].x_1 = floatX*3;
    ...
    public String[] numbercolor = {"#E6E6FA", "#FFE4E1", "#AFEEEE", "#DDA0DD", "#AB82FF", "#9ee896", "#f7edb7", "#48D1CC", "#BBFFFF", "#efa5be"};
     ...
     * 回调成功
     */
    public void setOnSuccess(NumberHrdView.OnSuccessListener listener) {
        this.listener = listener;
    }

    public NumberHrdView.OnSuccessListener listener;
...
//                if(my_Square[1].x_0==0 && my_Square[1].y_0==0){
//                    listener.success();
//                }
