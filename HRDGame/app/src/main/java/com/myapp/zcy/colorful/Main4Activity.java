...
public class Main4Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    private NumberHrdView2 mNumberHrdView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mNumberHrdView = (NumberHrdView2) findViewById(R.id.numberhrdview2);
        ...
        Log.i("1212121",mTvHistory.toString());
        ...
        mp =MediaPlayer.create(this, R.raw.onefineday);
        ...
        mNumberHrdView.setOnSuccess(new NumberHrdView.OnSuccessListener() {
            ...
            public void success() {
                ...
                SharedPreUtils.put(Main4Activity.this, "abnerType", "");
                String scale = SharedPreUtils.getString(Main4Activity.this, "scale");
                Log.i("1212121","scale:"+scale);
                if (TextUtils.isEmpty(scale)) {
                    SharedPreUtils.put(Main4Activity.this, "scale", "" + lastTime);
                } else {
    ...
    private void toastMsg(String message) {
        if (alertShow) {
            alertShow = false;
            Alert mAlerter = Alerter.create(Main4Activity.this).
                    setText(message).
                    setDuration(2000).
    ...
    private void createHistory(){
        try {
            String history=SharedPreUtils.getString(Main4Activity.this,"scale");
            if(!TextUtils.isEmpty(history)){
                Data.setA(getTime(Integer.parseInt(history)));
